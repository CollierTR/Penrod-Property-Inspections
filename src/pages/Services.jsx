    ...
    <div className="">
      ...
      <div className="flex relative h-[600px] md:h-[600px] lg:h-[620px] xl:[1740px] flex-col justify-center place-items-center text-center">
        ...
        <div className='max-w-6xl absolute z-20 text-light flex flex-col gap-5 sm:gap-6 justify-center place-items-center shadow'>
          ...
          <p className='text-2xl sm:text-3xl text-pretty w-3/4 mb-6'>We provide a variety of services to meet your needs. Explore what we offer and find out how we can help you achieve your goals.</p>
      ...
      <div className="bg-primary border-t-2 border-t-light pb-16">
        ...
        <div className="mx-auto py-20 sm:p-20 grid grid-cols-1 lg:grid-cols-2 3xl:grid-cols-3 justify-center place-items-stretch bg-primary gap-4 lg:gap-6 w-11/12 xl:w-10/12">
